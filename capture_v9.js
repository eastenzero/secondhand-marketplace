...
(async () => {
    ...
    try {
        ...
        await page.screenshot({ path: path.join(OUT, 'secondhand_photo_hero_v9.png'), fullPage: false });
        console.log(' -> secondhand_photo_hero_v9.png');

        console.log('2. Capturing Item List (scrolling down)...');
        await page.evaluate(() => window.scrollBy(0, window.innerHeight / 2));
        await new Promise(r => setTimeout(r, 1000));
        await page.screenshot({ path: path.join(OUT, 'secondhand_photo_list_v9.png'), fullPage: false });
        console.log(' -> secondhand_photo_list_v9.png');
        ...
        await page.screenshot({ path: path.join(OUT, 'secondhand_photo_empty_v9.png'), fullPage: false });
        console.log(' -> secondhand_photo_empty_v9.png');
        ...
        await new Promise(r => setTimeout(r, 2000));
        await page.screenshot({ path: path.join(OUT, 'secondhand_photo_detail_v9.png'), fullPage: false });
        console.log(' -> secondhand_photo_detail_v9.png');
        ...
        if (toggled) {
            ...
            await new Promise(r => setTimeout(r, 2000));
            // Save compare image
            await page.screenshot({ path: path.join(OUT, 'secondhand_cartoon_compare_v9.png'), fullPage: false });
            console.log(' -> secondhand_cartoon_compare_v9.png');

            // Save webp style toggle
            await page.screenshot({
                path: path.join(OUT, 'secondhand_style_toggle_v9.webp'),
                type: 'webp',
                quality: 80,
            });
            console.log(' -> secondhand_style_toggle_v9.webp');
        } else {
